...
public class BillsPayMLJEWELLERS_Steps extends Base_Steps{
    ...
    public void BPSendout_MLJEWELLERS_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionMLJEWELLERS(), "ML JEWELLER'S LIVE SELLING Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP ML JEWELLER'S LIVE SELLING Account Number", "0");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "CAGAYAN ");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "KATHLEEN");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayMLJEWELLERSKptnData(kptnValues);
    ...
    public void BPSendout_MLJEWELLERS_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteMLJEWELLERSKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   M L  J E W E L L E R ' S    C H A N G E  D E T A I L S

    public void BPChangeDetails_MLJEWELLERS_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "ML JEWELLER'S LIVE SELLING Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayMLJEWELLERS1KPTN();
            type(billsPayPageObjects.RefNum(), "ML JEWELLER'S LIVE SELLING Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_MLJEWELLERS_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayMLJEWELLERS1KPTN();
    ...
    public void BPCancellation_MLJEWELLERS_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayMLJEWELLERSKPTN();
            type(billsPayPageObjects.RefNum(), "ML JEWELLER'S LIVE SELLING Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_MLJEWELLERS_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayMLJEWELLERSKPTN();
            type(billsPayPageObjects.RefNum(), "ML JEWELLER'S LIVE SELLING Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
