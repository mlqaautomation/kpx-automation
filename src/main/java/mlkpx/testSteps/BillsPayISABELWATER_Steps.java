...
public class BillsPayISABELWATER_Steps extends Base_Steps{
    ...
    public void BPSendout_ISABEL_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionIsabelWater(), "ISABEL WATER DISTRICT Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP ISABEL WATER Account Number", "17110813");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "Alferez ");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "Catherene");
        type(billsPayPageObjects.BPMiddleName(), "BP Middle Name", "Ciao");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayIsabelKptnData(kptnValues);
    ...
    public void BPSendout_ISABEL_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteIsabelKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   I S A B E L  W A T E R   C H A N G E  D E T A I L S

    public void BPChangeDetails_ISABEL_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "ISABEL WATER Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayIsabel1KPTN();
            type(billsPayPageObjects.RefNum(), "ISABEL WATER Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_ISABEL_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayIsabel1KPTN();
    ...
    public void BPCancellation_ISABEL_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayIsabelKPTN();
            type(billsPayPageObjects.RefNum(), "ISABEL WATER Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_ISABEL_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayIsabelKPTN();
            type(billsPayPageObjects.RefNum(), "ISABEL WATER Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
...
//            click(payoutPageObjects.PrintButton(), "Print");
    ...
    public void BPTransaction_ISABEL_01()throws Exception {
        waitSleep(5000);
    ...
    public void BPTransaction_ISABEL_02()throws Exception {
        waitSleep(5000);
        click(billsPayPageObjects.CustomerServices(), "Customer Service");
        click(billsPayPageObjects.BPTransactions(), "BP Partners Transactions");
        waitSleep(3000);
        reader.refreshTestData();
        waitSleep(3000);
        String RemoteBillsPayKPTN = reader.getRemoteBillsPayIsabelKPTN();
