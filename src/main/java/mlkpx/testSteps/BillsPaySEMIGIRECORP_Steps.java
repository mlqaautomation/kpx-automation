...
public class BillsPaySEMIGIRECORP_Steps extends Base_Steps{
    ...
    public void BPSendout_SEMIGIRECORP_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionSEMIGIRECORP(), "SEMIGIRE CORPORATION-ORIENTAL Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP SEMIGIRE CORPORATION-ORIENTAL Account Number", "305170004594");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "BALQUIN ");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "BERNIE ");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPaySEMIGIRECORPKptnData(kptnValues);
    ...
    public void BPSendout_SEMIGIRECORP_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteSEMIGIRECORPKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   S E M I G I R E  C O R P O R A T I O N  C H A N G E  D E T A I L S

    public void BPChangeDetails_SEMIGIRECORP_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "SEMIGIRE CORPORATION-ORIENTAL Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPaySEMIGIRECORP1KPTN();
            type(billsPayPageObjects.RefNum(), "SEMIGIRE CORPORATION-ORIENTAL Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_SEMIGIRECORP_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPaySEMIGIRECORP1KPTN();
    ...
    public void BPCancellation_SEMIGIRECORP_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPaySEMIGIRECORPKPTN();
            type(billsPayPageObjects.RefNum(), "SEMIGIRE CORPORATION-ORIENTAL Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))){
    ...
    public void BPCancellation_SEMIGIRECORP_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPaySEMIGIRECORPKPTN();
            type(billsPayPageObjects.RefNum(), "SEMIGIRE CORPORATION-ORIENTAL Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
