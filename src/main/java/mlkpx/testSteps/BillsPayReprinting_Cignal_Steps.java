...
public class BillsPayReprinting_Cignal_Steps extends Base_Steps{
    ...
    public void validateSuccessfulBillsPayCIGNALReprinting()throws Exception{
        waitSleep(2000);
...
//            click(payoutPageObjects.PrintButton(), "Print");
    ...
    public void validateSuccessfulRemoteBillsPayCIGNALReprinting()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPReprinting());
        click(billsPayPageObjects.BPReprinting(), "Bills Pay Reprinting");
        if(isVisible(billsPayPageObjects.BillsPayPrint(), getText(billsPayPageObjects.BillsPayPrint()))) {
...
//            click(payoutPageObjects.PrintButton(), "Print");
    ...
    public void validateInvalidKTPNBillsPayCIGNALReprinting()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPReprinting());
        click(billsPayPageObjects.BPReprinting(), "Bills Pay Reprinting");
        if(isVisible(billsPayPageObjects.BillsPayPrint(), getText(billsPayPageObjects.BillsPayPrint()))) {
    ...
    public void validateEmptyRefBillsPayCIGNALReprinting()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPReprinting());
        click(billsPayPageObjects.BPReprinting(), "Bills Pay Reprinting");
        if(isVisible(billsPayPageObjects.BillsPayPrint(), getText(billsPayPageObjects.BillsPayPrint()))) {
    ...
    public void validateEmptyReasonBillsPayCIGNALReprinting()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPReprinting());
        click(billsPayPageObjects.BPReprinting(), "Bills Pay Reprinting");
        if(isVisible(billsPayPageObjects.BillsPayPrint(), getText(billsPayPageObjects.BillsPayPrint()))) {
    ...
    public void validateOnlyLettersBillsPayCIGNALReprinting()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPReprinting());
        click(billsPayPageObjects.BPReprinting(), "Bills Pay Reprinting");
        if(isVisible(billsPayPageObjects.BillsPayPrint(), getText(billsPayPageObjects.BillsPayPrint()))) {
