...
public class BillsPayHELPMATETALISAY_Steps extends Base_Steps{
    ...
    public void BPSendout_HELPMATETALISAY_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionHELPMATETALISAY(), "HELPMATE INC. - TALISAY Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP HELPMATE INC. - TALISAY Account Number", "SO2210623");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "CANETE ");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "LARRY");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayHELPMATETALISAYKptnData(kptnValues);
    ...
    public void BPSendout_HELPMATETALISAY_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteHELPMATETALISAYKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y  H E L P M A T E  T A L I S A Y   C H A N G E  D E T A I L S

    public void BPChangeDetails_HELPMATETALISAY_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "HELPMATE INC. - TALISAY Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayHELPMATETALISAY1KPTN();
            type(billsPayPageObjects.RefNum(), "HELPMATE INC. - TALISAY Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_HELPMATETALISAY_02()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayHELPMATETALISAY1KPTN();
    ...
    public void BPCancellation_HELPMATETALISAY_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayHELPMATETALISAYKPTN();
            type(billsPayPageObjects.RefNum(), "HELPMATE INC. - TALISAY Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_HELPMATETALISAY_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayHELPMATETALISAYKPTN();
            type(billsPayPageObjects.RefNum(), "HELPMATE INC. - TALISAY Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
