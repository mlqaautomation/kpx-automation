...
public class BillsPayBREADANDMORE_Steps extends Base_Steps{
    ...
    public void BPSendout_01()throws Exception {
        waitSleep(5000);
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionBREADANDMORE(), "BillsPay Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP Account Number", "3313331218082");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayBREADANDMOREKptnData(kptnValues);
    ...
    public void BPSendoutRemote_02()throws Exception {
        waitSleep(5000);
        waitUntilLoadingGone(10000);
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteBREADANDMOREKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y    C H A N G E  D E T A I L S
    ...
    public void BPChangeDetails_01()throws Exception{
        waitSleep(2000);
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayBREADANDMORE1KPTN();
            type(billsPayPageObjects.RefNum(), "Billspay Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetailsRemote_02()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "Bills Pay Change Details");
        waitSleep(5000);
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayBREADANDMORE1KPTN();
            type(billsPayPageObjects.RefNum(), "Billspay KTPN Number",RemoteBillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayBREADANDMOREKPTN();
            type(billsPayPageObjects.RefNum(), "Billspay Cancellation KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))){
    ...
    public void BPCancellationRemote_02()throws Exception{
        //Must need to cancel before/within five minutes.
        waitSleep(30000);
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayBREADANDMOREKPTN();
            type(billsPayPageObjects.RefNum(), "Billspay Cancellation KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPReprinting_01()throws Exception{
        waitSleep(15000);
...
//            click(payoutPageObjects.PrintButton(), "Print");
    ...
    public void BPReprintingRemote_02()throws Exception{
        waitSleep(15000);
        scrollToElement(billsPayPageObjects.BPReprinting());
        click(billsPayPageObjects.BPReprinting(), "Bills Pay Reprinting");
        if(isVisible(billsPayPageObjects.BillsPayPrint(), getText(billsPayPageObjects.BillsPayPrint()))) {
