...
public class BillsPayJOHNFOUNDATION_Steps extends Base_Steps{
    ...
    public void BPSendout_JOHNFOUNDATION_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionJOHNFOUNDATION(), "JOHN B. LACSON FOUNDATION Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP JOHN B. LACSON FOUNDATION Account Number", "JA2100294");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "SIAROT");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "ENRIQUE");
        type(billsPayPageObjects.BPMiddleName(), "BP Middle Name", "TESTS");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayJOHNFOUNDATIONKptnData(kptnValues);
    ...
    public void BPSendout_JOHNFOUNDATION_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteJOHNFOUNDATIONKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y    J O H N  F O U N D A T I O N   C H A N G E  D E T A I L S

    public void BPChangeDetails_JOHNFOUNDATION_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "JOHN B. LACSON FOUNDATION Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayJOHNFOUNDATION1KPTN();
            type(billsPayPageObjects.RefNum(), "JOHN B. LACSON FOUNDATION Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_JOHNFOUNDATION_02()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "Bills Pay JOHN B. LACSON FOUNDATION Change Details");
        waitSleep(5000);
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            LoggingUtils.info("Navigated the BillsPay Change Details page");
            waitSleep(3000);
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayJOHNFOUNDATION1KPTN();
            type(billsPayPageObjects.RefNum(), "JOHN B. LACSON FOUNDATION KTPN Number",RemoteBillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_JOHNFOUNDATION_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayJOHNFOUNDATIONKPTN();
            type(billsPayPageObjects.RefNum(), "JOHN B. LACSON FOUNDATION Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))){
            type(billsPayPageObjects.IRNum(), "JOHN B. LACSON FOUNDATION KTPN Number", "2111111111262");
    ...
    public void BPCancellation_JOHNFOUNDATION_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayJOHNFOUNDATIONKPTN();
            type(billsPayPageObjects.RefNum(), "JOHN B. LACSON FOUNDATION Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
