...
public class BillsPayMOELCI_1_Steps extends Base_Steps{
    ...
    public void BPSendout_MOELCI_01()throws Exception {
        waitSleep(5000);
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionMOELCI(), "MOELCI-1 Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP MOELCI-1 Account Number", "4048000215");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayMOELCIKptnData(kptnValues);
    ...
    public void BPSendout_MOELCI_02()throws Exception {
        waitSleep(5000);
        waitUntilLoadingGone(10000);
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteMOELCIKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   M I S A M I S  E L E C T R I C  C H A N G E  D E T A I L S

    public void BPChangeDetails_MOELCI_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "MOELCI-1 Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayMOELCI1KPTN();
            type(billsPayPageObjects.RefNum(), "MOELCI-1 Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_MOELCI_02()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayMOELCI1KPTN();
    ...
    public void BPCancellation_MOELCI_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayMOELCIKPTN();
            type(billsPayPageObjects.RefNum(), "MOELCI-1 Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_MOELCI_02()throws Exception{
        //Must need to cancel before/within five minutes.
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPCancellation());
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayMOELCIKPTN();
            type(billsPayPageObjects.RefNum(), "MOELCI-1 Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPReprinting_MOELCI_01()throws Exception{
        waitSleep(2000);
...
//            click(payoutPageObjects.PrintButton(), "Print");
    ...
    public void BPReprinting_MOELCI_02()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPReprinting());
        click(billsPayPageObjects.BPReprinting(), "Bills Pay Reprinting");
        if(isVisible(billsPayPageObjects.BillsPayPrint(), getText(billsPayPageObjects.BillsPayPrint()))) {
