...
public class BillsPayRMGCORP_Steps extends Base_Steps{
    ...
    //B I L L S  P A Y   R M G  C O R P O R A T I O N  S E N D O U T
    public void BPSendout_RMGCORP_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionMOELCI(), "RMG MANAGEMENT CORPORATION Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP RMG MANAGEMENT CORPORATION Account Number", "4048000215");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayRMGCORPKptnData(kptnValues);
    ...
    public void BPSendout_RMGCORP_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteRMGCORPKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   R M G  C O R P O R A T I O N  C H A N G E  D E T A I L S

    public void BPChangeDetails_RMGCORP_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "RMG MANAGEMENT CORPORATION Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayRMGCORP1KPTN();
            type(billsPayPageObjects.RefNum(), "RMG MANAGEMENT CORPORATION Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_RMGCORP_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayRMGCORP1KPTN();
    ...
    //B I L L S  P A Y   R M G  C O R P O R A T I O N   C A N C E L L A T I O N
    ...
    public void BPCancellation_RMGCORP_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayRMGCORPKPTN();
            type(billsPayPageObjects.RefNum(), "RMG MANAGEMENT CORPORATION Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_RMGCORP_02()throws Exception{
        //Must need to cancel before/within five minutes.
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPCancellation());
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayRMGCORPKPTN();
            type(billsPayPageObjects.RefNum(), "RMG MANAGEMENT CORPORATION Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    //B I L L S  P A Y   R M G  C O R P O R A T I O N   R E P R I N T I N G
