...
public class BillsPayCEBUINSTITUTETECH_Steps extends Base_Steps{
    ...
    //B I L L S  P A Y   C E B U  I N S T I T U T E  T E C H  S E N D O U T
    public void BPSendout_CEBUINSTITUTETECH_01()throws Exception {
        waitSleep(5000);
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionCEBUINSTITUTETECH(), "CEBU INSTITUTE OF TECHNOLOGY Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP CEBU INSTITUTE OF TECHNOLOGY Account Number", "221732785");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayCEBUINSTITUTETECHKptnData(kptnValues);
    ...
    public void BPSendout_CEBUINSTITUTETECH_02()throws Exception {
        waitSleep(5000);
        waitUntilLoadingGone(10000);
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteCEBUINSTITUTETECHKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   C E B U  I N S T I T U T E  T E C H  C H A N G E  D E T A I L S

    public void BPChangeDetails_CEBUINSTITUTETECH_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "CEBU INSTITUTE OF TECHNOLOGY Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayCEBUINSTITUTETECH1KPTN();
            type(billsPayPageObjects.RefNum(), "CEBU INSTITUTE OF TECHNOLOGY Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_CEBUINSTITUTETECH_02()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayCEBUINSTITUTETECH1KPTN();
    ...
    //B I L L S  P A Y   C E B U  I N S T I T U T E  T E C H   C A N C E L L A T I O N

    public void BPCancellation_CEBUINSTITUTETECH_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayCEBUINSTITUTETECHKPTN();
            type(billsPayPageObjects.RefNum(), "CEBU INSTITUTE OF TECHNOLOGY Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))){
    ...
    public void BPCancellation_CEBUINSTITUTETECH_02()throws Exception{
        //Must need to cancel before/within five minutes.
        waitSleep(10000);
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayCEBUINSTITUTETECHKPTN();
            type(billsPayPageObjects.RefNum(), "CEBU INSTITUTE OF TECHNOLOGY Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    //B I L L S  P A Y   C E B U  I N S T I T U T E  T E C H   R E P R I N T I N G
    public void BPReprinting_CEBUINSTITUTETECH_01()throws Exception{
        waitSleep(10000);
...
//            click(payoutPageObjects.PrintButton(), "Print");
    ...
    public void BPReprinting_CEBUINSTITUTETECH_02()throws Exception{
        waitSleep(10000);
        scrollToElement(billsPayPageObjects.BPReprinting());
        click(billsPayPageObjects.BPReprinting(), "Bills Pay Reprinting");
        if(isVisible(billsPayPageObjects.BillsPayPrint(), getText(billsPayPageObjects.BillsPayPrint()))) {
