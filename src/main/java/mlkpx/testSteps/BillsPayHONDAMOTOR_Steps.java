...
public class BillsPayHONDAMOTOR_Steps extends Base_Steps{
    ...
    public void BPSendout_HONDAMOTOR_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionHONDAMOTOR(), "HONDA MOTOR WORLD, INC. Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP HONDA MOTOR WORLD, INC. Account Number", "HMWIBAC060124");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "ARSULA  ");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "AGA MAE ");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayHONDAMOTORKptnData(kptnValues);
    ...
    public void BPSendout_HONDAMOTOR_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteHONDAMOTORKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y    H O N D A  M O T O R  W O R L D  C H A N G E  D E T A I L S

    public void BPChangeDetails_HONDAMOTOR_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "HONDA MOTOR WORLD, INC. Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayHONDAMOTOR1KPTN();
            type(billsPayPageObjects.RefNum(), "HONDA MOTOR WORLD, INC. Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_HONDAMOTOR_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayHONDAMOTOR1KPTN();
    ...
    public void BPCancellation_HONDAMOTOR_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayHONDAMOTORKPTN();
            type(billsPayPageObjects.RefNum(), "HONDA MOTOR WORLD, INC. Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))){
    ...
    public void BPCancellation_HONDAMOTOR_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayHONDAMOTORKPTN();
            type(billsPayPageObjects.RefNum(), "HONDA MOTOR WORLD, INC. Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
