...
public class BillsPayGOLDENBRIA_Steps extends Base_Steps{
    ...
    public void BPSendout_GOLDENBRIA_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionGOLDENBRIA(), "GOLDEN BRIA HOLDINGS INC Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP GOLDEN BRIA HOLDINGS INC Account Number", "CDO026766");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "RIVAS");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "SILFAS LORRAINE");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayGOLDENBRIAKptnData(kptnValues);
    ...
    public void BPSendout_GOLDENBRIA_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteGOLDENBRIAKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   G O L D E N   B R I A  C H A N G E  D E T A I L S

    public void BPChangeDetails_GOLDENBRIA_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "GOLDEN BRIA HOLDINGS INC Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayGOLDENBRIA1KPTN();
            type(billsPayPageObjects.RefNum(), "GOLDEN BRIA HOLDINGS INC Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_GOLDENBRIA_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayGOLDENBRIA1KPTN();
    ...
    public void BPCancellation_GOLDENBRIA_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayGOLDENBRIAKPTN();
            type(billsPayPageObjects.RefNum(), "GOLDEN BRIA HOLDINGS INC Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_GOLDENBRIA_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayGOLDENBRIAKPTN();
            type(billsPayPageObjects.RefNum(), "GOLDEN BRIA HOLDINGS INC Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
