...
public class BillsPayBBBROTHERSPHINC_Steps extends Base_Steps{
    ...
    public void BPSendout_BBBROTHERSPHINC_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionBBBROTHERSPHINC(), "BBBROTHERS PHILIPPINES INC 001 Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP BBBROTHERS PHILIPPINES INC 001 Account Number", "008358004564");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "Battung");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "Roderick ");
        type(billsPayPageObjects.BPMiddleName(), "BP Middle Name", "P");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayBBBROTHERSPHINCKptnData(kptnValues);
    ...
    public void BPSendout_BBBROTHERSPHINC_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteBBBROTHERSPHINCKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y    B B B R O T H E R S   P H   I N C   C H A N G E  D E T A I L S

    public void BPChangeDetails_BBBROTHERSPHINC_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "BBBROTHERS PHILIPPINES INC 001 Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayBBBROTHERSPHINC1KPTN();
            type(billsPayPageObjects.RefNum(), "BBBROTHERS PHILIPPINES INC 001 Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_BBBROTHERSPHINC_02()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "Bills Pay BBBROTHERS PHILIPPINES INC 001 Change Details");
        waitSleep(5000);
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            LoggingUtils.info("Navigated the BillsPay Change Details page");
            waitSleep(3000);
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayBBBROTHERSPHINC1KPTN();
            type(billsPayPageObjects.RefNum(), "BBBROTHERS PHILIPPINES INC 001 KTPN Number",RemoteBillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_BBBROTHERSPHINC_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayBBBROTHERSPHINCKPTN();
            type(billsPayPageObjects.RefNum(), "BBBROTHERS PHILIPPINES INC 001 Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))){
            type(billsPayPageObjects.IRNum(), "BBBROTHERS PHILIPPINES INC 001 KTPN Number", "2111111111262");
    ...
    public void BPCancellation_BBBROTHERSPHINC_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayBBBROTHERSPHINCKPTN();
            type(billsPayPageObjects.RefNum(), "BBBROTHERS PHILIPPINES INC 001 Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
