...
public class BillsPayEIGHTCHAMP_Steps extends Base_Steps{
    ...
    //B I L L S  P A Y  E I G H T C H A M P  S E N D O U T
    public void BPSendout_EIGHTCHAMP_01()throws Exception {
        ...
        scrollVertically(By.cssSelector("[class=' css-11unzgr']"),3000);
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionEIGHTCHAMP(), "EIGHTCHAMP DISTRIBUTION - BUTUAN Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP EIGHTCHAMP DISTRIBUTION - BUTUAN Account Number", "0373037574326");
        type(billsPayPageObjects.BPLastName(), "BP Last Name", "DALOGDOG ");
        type(billsPayPageObjects.BPFirstName(), "BP First Name", "STEPHEN JOHN");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayEIGHTCHAMPKptnData(kptnValues);
    ...
    public void BPSendout_EIGHTCHAMP_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteEIGHTCHAMPKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   E I G H T C H A M P  C H A N G E  D E T A I L S

    public void BPChangeDetails_EIGHTCHAMP_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "EIGHTCHAMP DISTRIBUTION - BUTUAN Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayEIGHTCHAMP1KPTN();
            type(billsPayPageObjects.RefNum(), "EIGHTCHAMP DISTRIBUTION - BUTUAN Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_EIGHTCHAMP_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayEIGHTCHAMP1KPTN();
    ...
    //B I L L S  P A Y   E I G H T C H A M P   C A N C E L L A T I O N
    ...
    public void BPCancellation_EIGHTCHAMP_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayEIGHTCHAMPKPTN();
            type(billsPayPageObjects.RefNum(), "EIGHTCHAMP DISTRIBUTION - BUTUAN Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_EIGHTCHAMP_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayEIGHTCHAMPKPTN();
            type(billsPayPageObjects.RefNum(), "EIGHTCHAMP DISTRIBUTION - BUTUAN Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    //B I L L S  P A Y   E I G H T C H A M P   R E P R I N T I N G
