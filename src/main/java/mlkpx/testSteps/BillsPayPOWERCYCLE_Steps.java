...
public class BillsPayPOWERCYCLE_Steps extends Base_Steps{
    ...
    //B I L L S  P A Y   P O W E R C Y C L E  I N C.   S E N D O U T
    public void BPSendout_POWERCYCLE_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionPowerCycle(), "POWERCYCLE INC. Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP POWERCYCLE INC. Account Number", "290R00000000");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayPowerCycleKptnData(kptnValues);
    ...
    public void BPSendout_POWERCYCLE_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemotePowerCycleKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   P O W E R C Y C L E  I N C.   C H A N G E  D E T A I L S

    public void BPChangeDetails_POWERCYCLE_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "POWERCYCLE INC. Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayPowerCycle1KPTN();
            type(billsPayPageObjects.RefNum(), "POWERCYCLE INC. Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_POWERCYCLE_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayPowerCycle1KPTN();
    ...
    //B I L L S  P A Y   P O W E R C Y C L E  I N C.   C A N C E L L A T I O N
    ...
    public void BPCancellation_POWERCYCLE_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayPowerCycleKPTN();
            type(billsPayPageObjects.RefNum(), "POWERCYCLE INC. Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_POWERCYCLE_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayPowerCycleKPTN();
            type(billsPayPageObjects.RefNum(), "POWERCYCLE INC. Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    //B I L L S  P A Y   P O W E R C Y C L E  I N C.  R E P R I N T I N G
