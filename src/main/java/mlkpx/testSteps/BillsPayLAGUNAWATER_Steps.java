...
public class BillsPayLAGUNAWATER_Steps extends Base_Steps{
    ...
    public void BPSendout_LAGUNA_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionLagunaWater(), "LAGUNA WATER CORPORATION Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP LAGUNA WATER CORPORATION Account Number", "30061003");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayLagunaKptnData(kptnValues);
    ...
    public void BPSendout_LAGUNA_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteLagunaKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y  L A G U N A  W A T E R   C H A N G E  D E T A I L S

    public void BPChangeDetails_LAGUNA_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "LAGUNA WATER CORPORATION Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayLaguna1KPTN();
            type(billsPayPageObjects.RefNum(), "LAGUNA WATER CORPORATION Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_LAGUNA_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayLaguna1KPTN();
    ...
    public void BPCancellation_LAGUNA_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayLagunaKPTN();
            type(billsPayPageObjects.RefNum(), "LAGUNA WATER CORPORATION Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_LAGUNA_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayLagunaKPTN();
            type(billsPayPageObjects.RefNum(), "LAGUNA WATER CORPORATION Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
...
//            click(payoutPageObjects.PrintButton(), "Print");
    ...
    public void BPReprinting_LAGUNA_02()throws Exception{
        ...
        reader.refreshTestData();
        waitSleep(3000);
        String RemoteBillsPayKPTN = reader.getRemoteBillsPayLagunaKPTN();
