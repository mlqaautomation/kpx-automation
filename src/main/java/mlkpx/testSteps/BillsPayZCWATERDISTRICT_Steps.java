...
public class BillsPayZCWATERDISTRICT_Steps extends Base_Steps{
    ...
    public void BPSendout_ZCWATERDISTRICT_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionZCWATERDISTRICT(), "ZAMBOANGA CITY WATER DISTRICT Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP ZAMBOANGA CITY WATER DISTRICT Account Number", "2170406");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPayZCWATERDISTRICTKptnData(kptnValues);
    ...
    public void BPSendout_ZCWATERDISTRICT_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteZCWATERDISTRICTKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y    Z C  W A T E R  D I S T R I C T   C H A N G E  D E T A I L S

    public void BPChangeDetails_ZCWATERDISTRICT_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "ZAMBOANGA CITY WATER DISTRICT Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayZCWATERDISTRICT1KPTN();
            type(billsPayPageObjects.RefNum(), "ZAMBOANGA CITY WATER DISTRICT Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_ZCWATERDISTRICT_02()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "Bills Pay ZAMBOANGA CITY WATER DISTRICT Change Details");
        waitSleep(5000);
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            LoggingUtils.info("Navigated the BillsPay Change Details page");
            waitSleep(3000);
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPayZCWATERDISTRICT1KPTN();
            type(billsPayPageObjects.RefNum(), "ZAMBOANGA CITY WATER DISTRICT KTPN Number",RemoteBillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_ZCWATERDISTRICT_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPayZCWATERDISTRICTKPTN();
            type(billsPayPageObjects.RefNum(), "ZAMBOANGA CITY WATER DISTRICT Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))){
            type(billsPayPageObjects.IRNum(), "ZAMBOANGA CITY WATER DISTRICT KTPN Number", "2111111111262");
    ...
    public void BPCancellation_ZCWATERDISTRICT_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPayZCWATERDISTRICTKPTN();
            type(billsPayPageObjects.RefNum(), "ZAMBOANGA CITY WATER DISTRICT Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
