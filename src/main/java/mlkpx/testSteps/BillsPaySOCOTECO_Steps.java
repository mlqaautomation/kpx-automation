...
public class BillsPaySOCOTECO_Steps extends Base_Steps{
    ...
    public void BPSendout_SOCOTECOII_01()throws Exception {
        ...
        waitSleep(5000);
        click(billsPayPageObjects.ChooseOptionSOCOTECOII(), "SOCOTECO II Partner");
        waitUntilLoadingGone(10000);
        waitSleep(5000);
        type(billsPayPageObjects.BPAccNum(), "BP SOCOTECO II Account Number", "157257");
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            reader.writeBillsPaySOCOTECOIIKptnData(kptnValues);
    ...
    public void BPSendout_SOCOTECOII_02()throws Exception {
        ...
        if(isVisible(billsPayPageObjects.billsPay_ConfiInfo(), getText(billsPayPageObjects.billsPay_ConfiInfo()))) {
            ...
            String kptnText = getText(billsPayPageObjects.kptnText());
            List<String> kptnValues = Collections.singletonList(kptnText);
            reader.writeBillsPayRemoteSOCOTECOIIKptnData(kptnValues);
            LoggingUtils.info("Bills Pay Successful" +
                    "The payment was successfully created." +
                    "Please prepare printer to print document.");
            click(billsPayPageObjects.proceedToPrinting(), "Proceed to Printing");
...
//B I L L S  P A Y   S O C OT E C O  I I  C H A N G E  D E T A I L S

    public void BPChangeDetails_SOCOTECOII_01()throws Exception{
        waitSleep(2000);
        scrollToElement(billsPayPageObjects.BPChangeDetails());
        click(billsPayPageObjects.BPChangeDetails(), "SOCOTECO II Partner Bills Pay Change Details");
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPaySOCOTECOII1KPTN();
            type(billsPayPageObjects.RefNum(), "SOCOTECO II Partner KTPN Number",BillsPayKPTN);
    ...
    public void BPChangeDetails_SOCOTECOII_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayChange(), getText(billsPayPageObjects.BillsPayChange()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String RemoteBillsPayKPTN = reader.getRemoteBillsPaySOCOTECOII1KPTN();
    ...
    //B I L L S  P A Y   S O C OT E C O  I I   C A N C E L L A T I O N
    ...
    public void BPCancellation_SOCOTECOII_01()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayKPTN = reader.getBillsPaySOCOTECOIIKPTN();
            type(billsPayPageObjects.RefNum(), "SOCOTECO II Partner KTPN Number",BillsPayKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    public void BPCancellation_SOCOTECOII_02()throws Exception{
        ...
        if(isVisible(billsPayPageObjects.BillsPayText(), getText(billsPayPageObjects.BillsPayText()))) {
            ...
            reader.refreshTestData();
            waitSleep(3000);
            String BillsPayRemoteKPTN = reader.getRemoteBillsPaySOCOTECOIIKPTN();
            type(billsPayPageObjects.RefNum(), "SOCOTECO II Partner KTPN Number",BillsPayRemoteKPTN);
            click(billsPayPageObjects.SearchButton(), "Search Button");
        }
    ...
    //B I L L S  P A Y   S O C OT E C O  I I   R E P R I N T I N G
